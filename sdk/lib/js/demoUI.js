...
*
* user nanoScrollerjs for ui Lib
* */
...
var Scroller = Class.extend({
  ...
  attach:function($ele_){
    $ele_.nanoScroller((this._options)?this._options:undefined);
  },

  refresh:function($ele_){
    $ele_.nanoscroller((this._options)?this._options:undefined);
  },
