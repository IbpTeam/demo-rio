...
CREATE TABLE devices (lastSyncTime TEXT, branchName TEXT, resourcePath TEXT, ip TEXT, name TEXT, id INTEGER PRIMARY KEY, device_id TEXT);\
...
INSERT INTO category VALUES('./resources/logo/contacts.png',101,'Contacts','联系人');\
