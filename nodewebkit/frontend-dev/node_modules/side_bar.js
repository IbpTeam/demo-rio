...
/*                for(var i=0; i<labels.length; i++){
                    ...
                    self.tags.delegate("#"+labels[i], "click", function(){
                        console.log('label2 ========: ', labels[i]);
                        self.emit('do_filter', json, labels[i]);
                    });
                }*/
            }else{
                getDataById(get_labels, json[count].id);        
            }
        }
        getDataById(get_labels, json[0].id);
    }
}
    ...
    switch(keyword)
    {
        case '345':
            ...
            for (var i=0; i<json.length; i++) {
                ...
                getDataById(get_filter_result, json[i].id);
            }
            break;
        case '版本组':
...
SideBar.prototype.set_recent = function(json){
    ...
    function get_recent(recent_result){
        for(var i=0; i<recent_result.length; i++){
            var filename = (JSON.stringify(recent_result[i].filename)).replace(/\"/g, '');
    ...
    getRecentAccessData(get_recent, 10);
}
