    ...
    case 3:
      ...
      $(popup_menu).on('mouseup', function(e){
        switch($(e.target).text()){
          case '新建'://wangyu: add this action.
            var filetypes = ['文件夹', '文本文档', 'WPS Word文档', 'WPS Powerpoint文档', 'WPS Excel文档'];
            var sub_popup_menu = self.gen_popup_menu(filetypes);
