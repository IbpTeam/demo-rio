...
function Folder(jquery_element) {
    ...
    this.files.parent().on('mousedown', function(e) {
        switch(e.which){
        case 3:
            var contents = ['属性'];//'创建文件夹', '创建文档', '排列项目', 
...
//	if(file_arch_json.hasOwnProperty('root')){
//	    console.log('file_arch_json have root value');
//	}else{
//	    console.log('file_arch_json not have root value');	
//	}
...
Folder.prototype.show_folder_view = function() {
    ...
    switch(get_settings('liststyle')){
        case 0:
            global_self.files.append(gen_view_table(data_json));
            break;
        case 1:
            global_self.files.html(gen_files_view(data_json));
            break;
        default:
            global_self.files.html(gen_files_view(data_json));
            break;
