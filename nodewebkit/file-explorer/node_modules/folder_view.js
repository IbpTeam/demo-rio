...
function gen_files_view(files){
    ...
    for(var i=0; i<files.length; i++){
        ...
        if(files[i].img){
            ...
            result.push('<div class="icon"> <img src="icons/' + files[i].data_type + '.png"></div>');
        }
...
Folder.prototype.get_callback_data = function(data_json){
    ...
    case 'root/Contacts':
	    for(var i=0; i<data_json.length; i++){
	        ...
	        data_json[i]['data_type'] = 'contacts';
	    }
        break;
    case 'root/Pictures':
	    for(var i=0; i<data_json.length; i++){
	        ...
	        data_json[i]['data_type'] = 'pictures';
	    }
        break;
    case 'root/Music':
	    for(var i=0; i<data_json.length; i++){
	        data_json[i]['path'] = 'root/Music/'+data_json[i]['filename'];
	        data_json[i]['name'] = data_json[i]['filename'];
	        //data_json[i]['img'] = '.'+data_json[i]['photoPath'];	        
	        data_json[i]['data_type'] = 'music';
	    }
        break;
    case 'root/Documents':
	    for(var i=0; i<data_json.length; i++){
	        data_json[i]['path'] = 'root/Documents/'+data_json[i]['filename'];
	        data_json[i]['name'] = data_json[i]['filename'];
	        //data_json[i]['img'] = '.'+data_json[i]['photoPath'];	        
	        data_json[i]['data_type'] = 'documents';
	    }
        break;
    default:
        break;
