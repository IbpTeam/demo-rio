...
SideBar.prototype.set_filters = function(json){
	...
	if(json.length){
		switch(json[0].data_type)
		{
		    case 'folder':
		        result.push('<form><input type="checkbox" name="filter_contact" />联系人</form>');
		        result.push('<form><input type="checkbox" name="filter_picture" />图片</form>');
		        result.push('<form><input type="checkbox" name="filter_music" />音乐</form>');
		        result.push('<form><input type="checkbox" name="filter_document" />文档</form>');
		        break;
		    case 'contacts':
		        result.push('<form><input type="checkbox" name="filter_135" />135开头</form>');
		        break;
		    case 'pictures':
		        result.push('<form><input type="checkbox" name="filter_group" />版本组</form>');
		        break;
		    case 'music':
		        result.push('<form><input type="checkbox" name="filter_jay" />周杰伦</form>');
		        break;
		    case 'documents':
		        result.push('<form><input type="checkbox" name="filter_hgj" />核高基项目</form>');
		        break;
		}
