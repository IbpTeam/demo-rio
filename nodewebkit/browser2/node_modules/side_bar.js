...
//		        result.push('<input type="button" id="filter_document" value="文档"/>');
		    ...
		    case 'Pictures':
		        ...
		        break;
		    case 'Music':
		        result.push('<input type="button" id="filter_jay" value="冯曦妤"/>');
    ...
    switch(keyword)
    {
        case '345开头':
            for(var i=0; i<json.length; i++){
                getDataById(function(result){
                    console.log("full information result:", result);
                    if(result.phone.match(keyword)){
                        filter_result.push(json[i]);
                    }  
                }, json[i].id);
            }
